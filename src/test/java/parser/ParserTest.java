...
public class ParserTest {
    ...
    public void testParseAddCommandWithLargeBuy() {
        ByteArrayOutputStream outputStreamCaptor = new ByteArrayOutputStream();
        System.setOut(new PrintStream(outputStreamCaptor));
        String userInput = "add itemname qty/1 /pc cat/test buy/9999999999999999999999999999999999999999999 sell/2";
        parser.parseInput(userInput);
    ...
    public void testParseAddCommandWithLargeSell() {
        ByteArrayOutputStream outputStreamCaptor = new ByteArrayOutputStream();
        System.setOut(new PrintStream(outputStreamCaptor));
        String userInput = "add itemname qty/1 /pc cat/test buy/1 sell/9999999999999999999999999999999999999999";
        parser.parseInput(userInput);
